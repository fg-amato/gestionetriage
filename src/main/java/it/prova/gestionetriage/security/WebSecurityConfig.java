...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler)
				...
				.permitAll().antMatchers("/public/**").permitAll().antMatchers("/api/paziente/**")
				.hasAnyAuthority("ROLE_ADMIN", "ROLE_SUB_OPERATOR").antMatchers(HttpMethod.GET, "/api/dottore/**")
				.hasAnyAuthority("ROLE_ADMIN", "ROLE_SUB_OPERATOR").antMatchers(HttpMethod.POST, "/api/dottore/search")
				.hasAnyAuthority("ROLE_ADMIN", "ROLE_SUB_OPERATOR").antMatchers("/api/dottore/**")
				.hasAnyAuthority("ROLE_ADMIN").antMatchers("/api/utente/**").hasAnyAuthority("ROLE_ADMIN").anyRequest()
				.authenticated();
